...
url = ("https://newsapi.org/v2/top-headlines?sources=business-insider&apiKey=6d5c12ae14bf4c71a9367094be76b4c2")
print('--------------------------------------------------------------------')
response = requests.get(url)
js = response.json()
...
url = ("https://newsapi.org/v2/top-headlines?category="+"entertainment"+"&apiKey=6d5c12ae14bf4c71a9367094be76b4c2")
response = requests.get(url)
js = response.json()
...
url = ("https://newsapi.org/v2/top-headlines?category="+"sports"+"&apiKey=6d5c12ae14bf4c71a9367094be76b4c2")
response = requests.get(url)
js = response.json()
...
url = ("https://newsapi.org/v2/top-headlines?category="+"technology"+"&apiKey=6d5c12ae14bf4c71a9367094be76b4c2")
response = requests.get(url)
js = response.json()
